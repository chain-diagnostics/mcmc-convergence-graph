...
# ============================================================
posterior_key <- "E"
posterior_name <- "three_cluster"
stan_file <- "~/Documents/Phd-cici/3pk/stan_file/three_cluster.stan"
stan_data <- list(d = 2, mu1 = c(-4, 0), mu2 = c(4, 0), mu3 = c(0, 4), sigma_lik = 0.6, sigma_prior = 20)
