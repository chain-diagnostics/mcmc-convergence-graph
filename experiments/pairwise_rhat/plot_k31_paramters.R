...
d1 <- dens_by_par[["k31"]]$d1
d2 <- dens_by_par[["k31"]]$d2
...
pdf_path <- file.path(docs_dir, "fig_experiment3_k31.pdf")
...
grDevices::dev.off()
file.copy(pdf_path, file.path(out_dir, "fig_experiment3_k31.pdf"), overwrite = TRUE)
cat("wrote", pdf_path, "\n")
