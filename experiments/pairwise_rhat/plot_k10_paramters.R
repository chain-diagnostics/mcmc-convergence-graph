...
d1 <- dens_by_par[["k10"]]$d1
d2 <- dens_by_par[["k10"]]$d2
...
pdf_path <- file.path(docs_dir, "fig_experiment3_k10.pdf")
...
grDevices::dev.off()
file.copy(pdf_path, file.path(out_dir, "fig_experiment3_k10.pdf"), overwrite = TRUE)
cat("wrote", pdf_path, "\n")
